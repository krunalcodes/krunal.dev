...
export const CASE_STUDIES: CaseStudy[] = [
  {
    slug: "llm-tax-automation",
    title: "LLM tax notice automation",
  ...
  },
  {
    ...
    categories: ["Media"],
    problem:
      "A high-traffic multilingual news site faced scaling bottlenecks and rising GCP costs.",
    architecture:
  ...
  {
    slug: "medical-exam-prep",
    title: "Medical entrance exam prep",
    headline: "Leading medical entrance exam prep platform in Australia & UK",
  ...
  {
    slug: "web3-trading-marketplace",
    title: "Web3 trading marketplace",
    headline: "Top-rated Web3 trading platform rebuild at peak adoption",
    company: "US Web3 startup",
    region: "United States",
    role: "Lead Engineer",
    categories: ["Web3"],
  ...
  },
  {
    ...
    title: "Secondary ticket marketplace",
    headline: "US secondary ticket marketplace built from scratch",
    company: "US marketplace startup",
    region: "United States",
  ...
  {
    slug: "freelance-gig-marketplace",
